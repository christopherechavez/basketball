...
public class reservation extends javax.swing.JFrame {
 ...
 public void displayData(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT * FROM reservations");
    ...
    if (rowIndex < 0) {
        ...
        ResultSet rs = cdb.getData("SELECT * FROM reservations WHERE r_id = '" + userId + "'");
        
        if (rs.next()) {
            a.rid.setText(rs.getString("r_id"));
            a.cid.setText(rs.getString("c_id"));
            a.et.setText(rs.getString("etime"));     
            a.revdate.setText(rs.getString("rdate"));
            a.st.setText(rs.getString("stime"));
